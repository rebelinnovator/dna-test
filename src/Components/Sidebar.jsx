...
const DragableImage = ({ id, type = "image", src, didDrop }) => {
  ...
  return (
    <div ref={drag} className="cursor-pointer border hover:border-red-400">
      <img
  ...
  return (
    <div className="">
      ...
      <div
        ...
        className="flex items-center justify-center border border-dashed border-[#4D4747] h-[120px] p-4 text-center md:mt-0 mt-3 cursor-pointer"
      >
        <input
          type="file"
          ref={inputRef}
